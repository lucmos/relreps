...
class SEResNet(nn.Module):
    def __init__(
        ...
        self.layer2 = self._make_layer(SEBasicBlock, 32, layers[1], stride=2)
        self.layer3 = self._make_layer(SEBasicBlock, 64, layers[2], stride=2)
        self.layer4 = self._make_layer(SEBasicBlock, 128, layers[3], stride=2)
