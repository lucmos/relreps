...
class SEResNet(nn.Module):
    def __init__(
        ...
        self.layer1 = self._make_layer(SEBasicBlock, 32, layers[0])
        self.layer2 = self._make_layer(SEBasicBlock, 64, layers[1], stride=1)
        self.layer3 = self._make_layer(SEBasicBlock, 128, layers[2], stride=1)
        self.layer4 = self._make_layer(SEBasicBlock, 256, layers[3], stride=1)
